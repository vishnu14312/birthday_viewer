...
class BirthdaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create birthday" do
    assert_difference('Birthday.count') do
      post birthdays_url, params: { birthday: { date: @birthday.date, name: @birthday.name, user_id: @birthday.user_id } }
    end
  ...
  test "should update birthday" do
    patch birthday_url(@birthday), params: { birthday: { date: @birthday.date, name: @birthday.name, user_id: @birthday.user_id } }
